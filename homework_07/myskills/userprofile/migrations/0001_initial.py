    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('direction', models.ManyToManyField(to='skillprofile.Direction')),
                ('parent_skill', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='skillprofile.userskillprofile')),
                ('skill', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='skillprofile.skill')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='skillprofile.user')),
            ],
        ),
    ]
